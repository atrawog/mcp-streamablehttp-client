...
def main():
    ...
    print("\n💡 Try these commands:")
    print(f"   mcp-http-stdio --token  # Check and refresh tokens")
    print(f"   mcp-http-stdio --command 'fetch https://example.com'")
    print(f"   mcp-http-stdio -c 'search my query'")
    print(f"   mcp-http-stdio -t  # Short form for token check")
